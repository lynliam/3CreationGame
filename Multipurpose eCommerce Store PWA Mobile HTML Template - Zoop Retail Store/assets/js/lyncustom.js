...
$(".重庆酸辣粉").wrap('<a href="酸辣粉.html"></a>');
$(".烤包子").wrap('<a href="烤包子.html"></a>');
$(".烤生蚝").wrap('<a href="烤生蚝.html"></a>');
$(".牛杂").wrap('<a href="牛杂.html"></a>');
$(".肉夹馍").wrap('<a href="肉夹馍.html"></a>');
$(".炒米粉").wrap('<a href="炒米粉.html"></a>');
$(".清凉补").wrap('<a href="清凉补.html"></a>');
$(".芋泥冰").wrap('<a href="芋泥冰.html"></a>');
$(".串串烧烤").wrap('<a href="串串烧烤.html"></a>');
$(".烤脑花").wrap('<a href="烤脑花.html"></a>');
$(".果切").wrap('<a href="果切.html"></a>');
$(".offer-1, .homepage1-tab-detail1s-wrapper").wrap('<a href="clothes-screen.html"></a>');
